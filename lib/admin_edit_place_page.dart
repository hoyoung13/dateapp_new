  ...
  Future<void> _save() async {
    ...
    await http.patch(uri,
        ...
        body: jsonEncode({
          ...
          'images':
              imagesCtrl.text.isNotEmpty ? imagesCtrl.text.split(',') : null,
          'hashtags': hashtagsCtrl.text.isNotEmpty
              ? hashtagsCtrl.text.split(',')
              : null,
        }));
        ...
        child: ListView(
          children: [
            ...
            TextField(
                ...
                decoration: const InputDecoration(labelText: '이미지들(,로 구분)')),
            TextField(
                controller: hashtagsCtrl,
                decoration: const InputDecoration(labelText: '해시태그(,로 구분)')),
